...
namespace ListomoraFront.Pages.Articles
{
    public partial class MyArticles
    {
        ...
        {
            Articles = await _client.GetMineAsync();
        }
        public void GoToDetails(Guid id)
        {
            _navigationManager.NavigateTo("/article/details/mine/" + id);
        }
        public void GoToUpdate(Guid id)
        {
            _navigationManager.NavigateTo("/article/update/mine/" + id);
        }
        ...
        {
            _navigationManager.NavigateTo("/article/create/mine");
        }
    }
}
