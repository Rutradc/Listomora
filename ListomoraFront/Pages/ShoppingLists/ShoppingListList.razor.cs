...
namespace ListomoraFront.Pages.ShoppingLists
{
    public partial class ShoppingListList
    {
        ...
        {
            ShoppingLists = await _client.GetAllAsync();
        }
        public void GoToDetails(Guid id)
        {
            _navigationManager.NavigateTo("/shoppinglist/page/adminlist/" + id);
        }
        public async void GoToCreate()
        {
            _navigationManager.NavigateTo("/shoppinglist/page/adminlist/");
        }
    }
}
